...
class TestDBStorage(unittest.TestCase):
    ...
    def test_new(self):
        ...
        self.assertIn('tony2024@gmail.com', result)
        self.assertIn('password', result)
        self.assertIn('Tony', result)
        self.assertIn('Rasheed', result)
        cursor.close()
        dbc.close()
